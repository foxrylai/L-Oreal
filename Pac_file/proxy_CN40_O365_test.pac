...
// CN40 site specific
    // Global URLs redirected to HKD Proxy
    if (
 ...
 if (
    ...
    shExpMatch(url,"*metrics.brightcove.com*") ||
	shExpMatch(host,"*.akamaihd.net") ||
	shExpMatch(host,"*.nomadic.fm") ||
	shExpMatch(host,"*.remoteteambuilding.com") ||
    shExpMatch(host,"*remoteteambuilding.com") ||
	shExpMatch(host,"*.thegogame.com") ||
    shExpMatch(host,"*.giphy.com") ||
    shExpMatch(host,"*.gstatic.com") ||
    shExpMatch(host,"*.cloudflare.com") ||
    shExpMatch(host,"*.ytimg.com") ||
    shExpMatch(host,"*.firebaseio.com") ||
	shExpMatch(host,"*.ironcladapp.com") ||
	shExpMatch(host,"*ironcladapp.com") ||
	shExpMatch(host,"web.microsoftstream.com") ||
	shExpMatch(host,"amsglob0cdnstream13.azureedge.net") ||
...
// OneDrive and Sharepoitn to local Zscaler node
  if (
...
// CN40 Exchange and Outlook via HKT ZSCALER
...
// Temporaary redirection for One Intelligence

  if (

    shExpMatch(host,"loreal-cdn-test.mip.marketlogicsoftware.com")
	||  shExpMatch(host,"loreal-cdn-ng.mip.marketlogicsoftware.com")
     )
  return "PROXY 185.46.212.88:80";


// Event CMD: connection of speakers from China
    // -----------------------------------
